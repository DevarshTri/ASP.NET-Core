...
namespace STORE_DataTransfer
{
    public class LogConfigurator
    {
        public static void ConfigureLogging()
        {
            ...
            {
                logPath = "A://LOG/EzOrderStockSyncService/logfile.log";
            }
            else if(Directory.Exists("D://"))
            {
                logPath = "D://LOG/EzOrderStockSyncService/logfile.log";
            }
            else if (Directory.Exists("E://"))
            {
                logPath = "E://LOG/EzOrderStockSyncService/logfile.log";
            }
            else if (Directory.Exists("F://"))
            {
                logPath = "F://LOG/EzOrderStockSyncService/logfile.log";
            }
            else
            {
                logPath = "C://LOG/EzOrderStockSyncService/logfile.log";
            }
